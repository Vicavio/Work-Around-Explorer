...
function updateResults() {
  ...
  const averageSalaryByRole = getAverageSalaryByRole(role); /* ???Replace each 0 with a call to the appropriate imported function from workAroundModule.js using either (or both) company and role as arguments. */
